                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="create-form pt-3" id="formdata" action="{{ route('teachers.store') }}" enctype="multipart/form-data" method="POST" novalidate="novalidate">
                            ...
                            {{-- <div class="dropdown">
                                <button class="btn btn-sm btn-inverse-dark dropdown-toggle d-flex align-items-center" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <i class="fa fa-ellipsis-v"></i>
                                </button>
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                    <a class="dropdown-item p-2" href="#">Action 1</a>
                                    <a class="dropdown-item p-2" href="#">Action 2</a>
                                    <a class="dropdown-item p-2" href="#">Action 3</a>
                                </div>
                            </div> --}}
