                        ...
                        <form id="formdata" class="create-form-without-reset" action="{{ route('system-settings.app.update') }}" novalidate="novalidate">
                            ...
                            <div class="pt-3 row">
                                <div class="form-group col-md-6 col-sm-12">
                                    <label for="app_link">{{ __('app_link') }} <span class="text-danger">*</span></label>
                                    <input name="app_link" id="app_link" value="{{ $settings['app_link'] ?? '' }}" type="url" required placeholder="{{ __('app_link') }}" class="form-control"/>
                                </div>
                                <div class="form-group col-md-6 col-sm-12">
                                    <label for="ios_app_link">{{ __('ios_app_link') }} <span class="text-danger">*</span></label>
                            ...
                            <div class="row">
                                <div class="form-group col-md-3 col-sm-12">
                                    <label for="app_version">{{ __('app_version') }} <span class="text-danger">*</span></label>
                                ...
                                <div class="form-group col-md-3 col-sm-12">
                                    <label for="ios_app_version">{{ __('ios_app_version') }} <span class="text-danger">*</span></label>
                            ...
                            <div class="pt-3 row">
                                <div class="form-group col-md-6 col-sm-12">
                                    <label for="app_link">{{ __('app_link') }} <span class="text-danger">*</span></label>
                                    <input name="teacher_app_link" required id="app_link" value="{{ $settings['teacher_app_link'] ?? '' }}" type="url" required placeholder="{{ __('app_link') }}" class="form-control"/>
                                </div>
                                <div class="form-group col-md-6 col-sm-12">
                                    <label for="ios_app_link">{{ __('ios_app_link') }} <span class="text-danger">*</span></label>
                                    <input name="teacher_ios_app_link" id="ios_app_link" value="{{ $settings['teacher_ios_app_link'] ?? '' }}" type="url" required placeholder="{{ __('ios_app_link') }}" class="form-control"/>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-md-3 col-sm-12">
                                    <label for="app_version">{{ __('app_version') }} <span class="text-danger">*</span></label>
                                    <input name="teacher_app_version" id="app_version" value="{{ $settings['teacher_app_version'] ?? '' }}" type="text" required placeholder="{{ __('app_version') }}" class="form-control"/>
                                </div>
                                <div class="form-group col-md-3 col-sm-12">
                                    <label for="ios_app_version">{{ __('ios_app_version') }} <span class="text-danger">*</span></label>
                                    <input type="text" name="teacher_ios_app_version" id="ios_app_version" required placeholder="{{ __('ios_app_version') }}" class="form-control" value="{{ $settings['teacher_ios_app_version'] ?? '' }}">
                                </div>
                                <div class="form-group col-md-3 col-sm-12">
                                    <label>{{ __('force_app_update') }}</label>
                                    <div class="form-check">
