                            ...
                            <div class="border border-secondary rounded-lg mb-3">
                                ...
                                <div class="row my-4 mx-1">
                                    ...
                                    <div class="form-group col-sm-12 col-md-6">
                                        ...
                                        <input type="text" name="gateway[Razorpay][api_key]" id="razorpay_api_key" class="form-control" placeholder="Razorpay Api Key" required value="{{$paymentGateway["Razorpay"]['api_key'] ?? ''}}">
                                    </div>

                                    <div class="form-group col-sm-12 col-md-6">
                                        <label for="razorpay_secret_key">{{__("Razorpay Secret Key")}} <span class="text-danger">*</span></label>
                                        <input type="text" name="gateway[Razorpay][secret_key]" id="razorpay_secret_key" class="form-control" placeholder="Razorpay Secret Key" required value="{{$paymentGateway["Razorpay"]['secret_key'] ??''}}">
                                    </div>

                                    <div class="form-group col-sm-12 col-md-6">
                                        <label for="razorpay_webhook_secret">{{__("Razorpay Webhook Secret")}} <span class="text-danger">*</span></label>
                                        <input type="text" name="gateway[Razorpay][webhook_secret_key]" id="razorpay_webhook_secret" class="form-control" placeholder="Razorpay Webhook Secret" required value="{{$paymentGateway["Razorpay"]['webhook_secret_key'] ?? ''}}">
                                    </div>
