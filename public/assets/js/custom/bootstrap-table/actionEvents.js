...
window.subscriptionEvents = {
    'click .edit-data': function (e, value, row) {
        ...
        if (row.subscription.package_type == 1) {
            ...
            html += '<th class="text-right">' + row.currency_symbol + ' ' + amountFormatter(row.amount, null) + '</th>';
            html += '</tr>';
            ...
            html += '<th class="text-right">' + row.currency_symbol + ' ' + amountFormatter((parseFloat(row.amount) + parseFloat(prepaid_total_addon_charges))) + '</th>';
